...
public class SmsUtil {
	...
	public List<SingleMessageSentResponse> sendOne(List<SmsRequestDto> orderList, Integer restockOrderId, String storeName) {
		...
		for (SmsRequestDto order : orderList) {
			...
			String deliveryStartAPI = "https://k10e204.p.ssafy.io/api/sms/" + restockOrderId + "/" + venderId + "/start";
			String deliveryEndAPI = "https://k10e204.p.ssafy.io/api/sms/" + restockOrderId + "/" + venderId + "/arrive";
